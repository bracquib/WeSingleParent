const CACHE_VERSION = '1.7.60.7';

const BASE_CACHE_FILES = [
    'https://q-rious.fr/wp-content/uploads/wesingleparents-website-favicon-color.png',
'https://q-rious.fr/wp-content/uploads/wesingleparents-low-resolution-color-logo.png',
'https://q-rious.fr/wp-content/uploads/wesingleparents-low-resolution-color-logo.png',
...
const OFFLINE_PAGE = 'https://q-rious.fr/';
const NOT_FOUND_PAGE = 'https://q-rious.fr/';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://q-rious.fr//wp-admin/');
//    },
];
